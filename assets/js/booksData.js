const booksData = [
  ...
  },
  {
    ...
    topics: [
      ...
      "Bank of the Future (Café bank, virtual reality banking, 5 skenario bank masa depan: Full-Service / Digital / Disaggregated / Conversational / Collaborative Bank)",
  ...
  },
  {
    ...
    topics: [
      ...
      "BGP Path Selection (12 langkah: Weight → Local Pref → AIGP → AS_PATH → Origin → MED → eBGP over iBGP)",
